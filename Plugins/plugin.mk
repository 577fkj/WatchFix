...
WATCHFIX_PLUGIN_CXX_INCLUDE ?= $(or $(wildcard $(ISYSROOT)/usr/include/c++/v1),$(shell xcrun --sdk iphoneos --show-sdk-path 2>/dev/null)/usr/include/c++/v1)
WATCHFIX_PLUGIN_CCFLAGS ?= -stdlib=libc++ -isystem $(WATCHFIX_PLUGIN_CXX_INCLUDE)
...
WATCHFIX_PLUGIN_MINIMUM_OS_VERSION ?= 14.0
